...
// ============================================================================
//
// Deprecated custom info blocks are located in the `custom_info` directory.
//
// The directory contains some of the more common uses of the Custom Info block
// that were standardized in past revisions, although now they are deprecated.
//
// ============================================================================
